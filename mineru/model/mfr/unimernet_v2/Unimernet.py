...
class UnimernetModel(object):
    def __init__(self, weight_dir, _device_="cpu"):
        ...
        model_config = {
            ...
            'model_config': {
                'max_seq_len': 1536, 
                'model_name': os.path.join(weight_dir, "nougat")
            }, 
            'model_type': 'unimernet'
        }
        
        from .unimernet.unimernet import UniMERModel
        from .unimernet.processor import FormulaImageEvalProcessor
        self.model = UniMERModel.from_config(OmegaConf.create(model_config))
        self.model.transform = FormulaImageEvalProcessor((384,1344))
        ...
        self.model = self.model.to(dtype=self.model.dtype)
        self.model.eval()
